...
const Titre=({params})=>{
  ...
  return <View style={{height:'auto',maxWidth:250,flexDirection:'column',borderRadius:8,paddingHorizontal:5,justifyContent:'center',backgroundColor:'rgba(250, 250, 250, 0.9)',alignItems:'center',borderWidth:2,borderColor:'rgba(255,255,255,0.4)',
              }}>
