...
const GraphesNav=({render})=>{
    ...
    return <View style={{flexDirection:'column',justifyContent:'flex-start',alignItems:'flex-start',gap:3,minWidth:1050,heigth:'auto',paddingHorizontal:10,paddingVertical:4,borderRadius:5,borderWidth:1,borderRightWidth:0,borderColor:'grey',backgroundColor:'rgba(240,240,240,0.2)'}}>
        <Text style={{color:primaryColor,height:20,backgroundColor:'rgba(0,0,0,0.15)',borderRadius:4,paddingVertical:20,textAlign:'center',marginBottom:20,letterSpacing:2,fontSize:14,fontWeight:'bold'}}>Graphiques</Text>
        <View style={{flexDirection:'row',justifyContent:'flex-start',gap:5,alignItems:'center',width:'auto',height:30}}>
