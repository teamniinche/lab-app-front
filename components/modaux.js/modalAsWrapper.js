...
export default function ModalWrapper({children,title,type}) {
  const {fWrapperShow,setFWrapperShow,wrapperShow,setWrapperShow,itemStored}=useFormules();
  const {dialogShow}=useNFormules();
        ...
        <View pointerEvents={dialogShow?"none":"auto"} style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity
              ...
              >
                <Text><FontAwesome5 name="times" size={15} color="red" /></Text>
              </TouchableOpacity>
          </View>
        </View>
      </Modal>
