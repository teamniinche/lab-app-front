...
return <TouchableOpacity style={{position:'absolute',right:25,top:10,backgroundColor:THEME.backgroundClr,padding:8,paddingHorizontal:24,borderRadius:8,}}  onPress={handleThemeChange}>
