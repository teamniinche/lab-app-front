...
# Commande officielle Expo pour exporter le projet en fichiers statiques Web # Pas d'optimisation
# RUN npx expo export --platform web

# Force l'export en mode développement pour sauter les optimisations lourdes #Optimisation en se debrassant du baratin d'optimisation
